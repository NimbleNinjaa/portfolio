			...
			<div class="row">
				...
				<div class="col-6 col-sm-4 col-md-3">
					<ul class="footer-menu-list mb-0">
						<li><a href="#" target="_blank" rel="noopener noreferrer" class="link letter-space--2 h5">GitHub</a></li>
						<li><a href="#" target="_blank" rel="noopener noreferrer" class="link letter-space--2 h5">LinkedIn</a></li>
						<li><a href="#" target="_blank" rel="noopener noreferrer" class="link letter-space--2 h5">X (Twitter)</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="img-agency">
				<img class="effectFade fadeZoom" loading="lazy" width="1293" height="269" src="/assets/images/logo/agency.png" alt="Hamid">
			</div>
			<div class="bottom">
